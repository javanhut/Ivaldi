...
| Crash-safe local operations | Kill/reopen matrices for seal, gather, reseal, fuse, weld, undo, rewind, reverse, timeline removal and rename, journaled timeline switching, Git and GitHub-compatible import landing, journaled diverged sync, atomic pack publication and idempotent verified receive, conservative recovery, and garbage collection |
